<x-app-layout>
    @push('styles')
        <!-- Aquí puedes incluir otros estilos personalizados si es necesario -->
    @endpush
    ...
    @push('scripts')
                ...
                var calendar = new FullCalendar.Calendar(calendarEl, {
                    ...
                    eventClick: function(info) {
                        ...
                        Swal.fire({
                            ...
                            didOpen: () => {
                                // Inicializar Select2 (la instancia de jQuery ya tiene el plugin cargado desde app.js)
        ...
        {{-- Cargar el bundle compilado (vía Vite) --}}
