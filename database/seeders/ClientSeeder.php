...
class ClientSeeder extends Seeder
{
    ...
    {
        // Cliente 1
        if (!Client::where('email', 'contacto@empresauno.es')->exists()) {
            Client::create([
        ...
        // Cliente 2
        if (!Client::where('email', 'juan.perez@autonomo.es')->exists()) {
            Client::create([
        ...
        // Cliente 3
        if (!Client::where('email', 'info@techglobalsolutions.com')->exists()) {
            Client::create([
