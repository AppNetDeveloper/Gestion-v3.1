...
class RoleSeeder extends Seeder
{
    public function run(): void
    {
        ...
        $adminPermissions = [
            ...
            'invoices index', 'invoices create', 'invoices update', 'invoices delete', 'invoices show', 'invoices send_email', 'invoices export_pdf', 'invoices sign', 'invoices verify',
        ...
        $customerPermissions = [
            ...
            'invoices index', 'invoices show', 'invoices view_own', 'invoices export_pdf', 'invoices verify',
